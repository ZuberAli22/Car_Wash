...
if(isset($_POST['edit_about']))
  {
    ...
    $sql="update tblpages set type='$pagetitle',detail='$pagedes' where  type='aboutus'";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="color:blue;">About Us</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
  ...
  $query="SELECT * FROM tblpages WHERE type='aboutus'";
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="pagedes" rows="4" value="" class="form-control"
                                            placeholder="Description"><?php echo $item['detail']; ?> </textarea>
                                    </div>
